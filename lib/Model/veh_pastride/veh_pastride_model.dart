class Veh_owner_pastride_modal {
  List<PastRides> pastRides;

  Veh_owner_pastride_modal({this.pastRides});

  Veh_owner_pastride_modal.fromJson(Map<String, dynamic> json) {
    if (json['pastRides'] != null) {
      pastRides = new List<PastRides>();
      json['pastRides'].forEach((v) {
        pastRides.add(new PastRides.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pastRides != null) {
      data['pastRides'] = this.pastRides.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class PastRides {
  ...
  PastRides.fromJson(Map<String, dynamic> json) {
    id = json['id'];
